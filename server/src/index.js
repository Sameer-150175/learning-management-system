...
const users = [];
const records = [
  { id: randomUUID(), title: "Demo course", status: "active", owner: "demo", priority: "medium", createdAt: new Date().toISOString() }
];
...
app.get("/api/health", (req, res) => {
  res.json({ status: "ok", service: "Learning Management System", uptime: process.uptime() });
});
...
app.listen(port, () => {
  console.log("Learning Management System API listening on " + port);
});
